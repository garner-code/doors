  ...
  if (version == "pilot-data-00") {
    ...
    if (exp == "exp_ts") {
      ...
      subs <- c("sub-01", "sub-02", "sub-03", "sub-04", "sub-05", "sub-06", "sub-07", "sub-08", "sub-09", "sub-10", 
                ...
                "sub-61", "sub-62", "sub-63", "sub-65", "sub-66", "sub-67", "sub-68", "sub-70",
                "sub-71", "sub-72", "sub-73", "sub-74") #"sub-64" only has one trial for house-1 ses-learn. "sub-69" currently doesn't exist
    }
  }
}
